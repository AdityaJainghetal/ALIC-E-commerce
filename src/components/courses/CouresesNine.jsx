...
//     try {
//       setLoading(true);
//       const res = await axios.get(`https://alic-backend-2.onrender.com/api/coursess/${id}`);
//       const mainCourse = res.data;
//       setProduct(mainCourse);

//       const relatedRes = await axios.get(
//         `https://alic-backend-2.onrender.com/api/courses?category=${mainCourse.category._id}`
//       );
  ...
  useEffect(() => {
    const fetchCourseAndSameCategory = async () => {
      ...
      try {
        ...
        const res = await axios.get(`https://alic-backend-2.onrender.com/api/courses/${id}`);
        const main = res.data;
        console.log(main)
        setMainCourse(main);
        ...
        const sameCategoryRes = await axios.get(
          `https://alic-backend-2.onrender.com/api/courses/category/${main.category._id}`
        );
