...
//       try {
//         const res = await axios.get(`https://alic-backend-2.onrender.com/syllabus/category/${id}`);
...
//       await axios.post("https://alic-backend-2.onrender.com/register/add", formData);
