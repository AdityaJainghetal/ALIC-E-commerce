...
//     try {
//       const response = await axios.get(`https://alic-backend-2.onrender.com/enroll/getproducts/${id}`);
...
export const Enroll = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(`https://alic-backend-2.onrender.com/enroll/${id}`, formData);
